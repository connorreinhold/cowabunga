...
public class CLI {
    ...
    /**
     * Creates an {@code Options} instance of the CLI parser. <\br>
     * In this instance, an {@code Option} instance is created for 
     * at least each of the following CLI options: 
     * {@literal --help}, {@literal --lex}, and 
     * {@literal -D <path>}.
     * 
     */
