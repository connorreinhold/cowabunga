...
public class InvalidStringEscapeCharacterException extends LexerException {
    ...
    private static final String validEscapeMsg =
            String.format("(valid escape characters are: %s)",
                    String.join(", ", validEscapes));

    public InvalidStringEscapeCharacterException(String c, int line, int column) {
