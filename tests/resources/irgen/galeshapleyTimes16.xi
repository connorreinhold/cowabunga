...
main_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
main2_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs2_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley2_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer2_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray2_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
main_1_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs_1_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley_1_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer_1_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray_1_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
main2_1_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs2_1_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley2_1_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer2_1_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray2_1_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
printArrayArray2_1_13243(a: int[][]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        printArray(a[i])
...
main_20_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs_20_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley_20_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer_20_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray_20_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
printArrayArray_20_13243(a: int[][]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        printArray(a[i])
...
main2_20_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs2_20_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley2_20_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer2_20_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray2_20_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
printArrayArray2_20_13243(a: int[][]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        printArray(a[i])
...
main_1_20_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs_1_20_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley_1_20_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer_1_20_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray_1_20_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
printArrayArray_1_20_13243(a: int[][]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        printArray(a[i])
...
main2_1_20_13243(prefData: int[][]) {
    proposerPrefs: int[][], respondentInvPrefs: int[][] = prefs(prefData)
    result: int[] = galeShapley(proposerPrefs, respondentInvPrefs)
    printArray(result)
}

prefs2_1_20_13243(prefData: int[][]): int[][], int[][] {
    n: int = length(prefData) / 2
...
galeShapley2_1_20_13243(proposerPrefs: int[][], respondentPrefsInv: int[][]): int[] {
    n: int = length(proposerPrefs)
...
respondentPrefersProposer2_1_20_13243(respondentPrefsInv: int[][], respondent: int, leftProposer: int, rightProposer: int): bool {
    leftPref: int = respondentPrefsInv[respondent][leftProposer]
    rightPref: int = respondentPrefsInv[respondent][rightProposer]
    return leftPref < rightPref
}

printArray2_1_20_13243(a: int[]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        print(unparseInt(a[i]))
...
printArrayArray2_1_20_13243(a: int[][]) {
    i: int = 0
    print("[")
    while (i < length(a)) {
        printArray(a[i])
